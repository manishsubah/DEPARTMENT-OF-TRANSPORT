...
class applearnerform extends JFrame implements Printable, ActionListener, KeyListener {
    String relation = "", fname = "", hname = "";
    ...
    applearnerform() {
        setTitle("Application Learner Licence");
        setSize(1050, 700);
        setResizable(false);
        ...
        try {
            ...
            String sql = "Select applicantid,name,husbandname,permanentadd,district,city,dob,bg,vehicletype1,vehicletype2,applydate,photoaddress,signatureaddress,relation,fathername from applicationlearner ORDER BY applicantid";
    ...
    applearnerform(String x) {
        ...
        try {
            ...
            Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "manish");
            Statement s = c.createStatement();
            String sql = "Select applicantid,name,husbandname,permanentadd,district,city,dob,bg,vehicletype1,vehicletype2,applydate,photoaddress,signatureaddress,relation,fathername from applicationlearner where applicantid='"
