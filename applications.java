...
class applications extends JFrame implements KeyListener, ActionListener {
    JScrollPane sp;
    JLabel lup;
    String fname = "", hname = "", trd = "", pp = "", ap = "", bp = "", pa = "", sa = "", tha = "", vclass = "";
    String v1 = "", v2 = "";
    String relation = "";
    String x = "", up = "";
    String extension = "";
    ...
    JButton b1, b2, b3, up1, up2, up3, show1, show2, show3;
    ...
    applications() {
        ...
        b1.setBounds(760, 640, 100, 30);
        b2.setBounds(870, 640, 150, 30);
        ...
        try {
            ...
            ResultSet rs = s.executeQuery("select count(applicantid) from feeappdl");
            if (rs.next()) {
                formno = formno + (Integer.valueOf(rs.getString(1)));
                l2.setText(formno);
            }
            c.close();
        } catch (Exception ec) {
        ...
        JOptionPane.showMessageDialog(this,
                "If you want to paste previous Learner Licence data , you will click on Paste Record button.",
                "DTO-CHAPRA", JOptionPane.INFORMATION_MESSAGE);

    }

    // ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    applications(String x1, String x2, String x3) {
        setTitle("Apply Smart Card");
        setSize(1350, 730);
        setResizable(false);
        setLocationRelativeTo(null);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b1) {
            if ((t3.getText()).equals("") || (t3.getText()).equals(null)) {
                ...
                if ((l7.getText()).equals("Father's Name :")) {
                    try {
                        Class.forName("oracle.jdbc.driver.OracleDriver");
            ...
            try {
                ...
                Statement s = c.createStatement();
                String sql = "Select name,sex,relation,husbandname,fathername,dob,bg,permanentadd,villtown,district,city,pin1,identity1,identity2,photoproof,addressproof,bgproof,presentadd1,presentadd2,pin2,email,addhar,mobile,photoaddress,signatureaddress,thumbaddress from learnerlicense WHERE learnerlicenseno='"
                        + t13.getText() + "' ";
                ...
                if (rs1.next()) {
                    ...
                    pa = rs1.getString(24);
                    sa = rs1.getString(25);
                    tha = rs1.getString(26);
                } else {
                    JOptionPane.showMessageDialog(this, "No data found OR This Learner Licence is not APPROVED.",
                            "Error", JOptionPane.ERROR_MESSAGE);
                }
                c.close();
            } catch (Exception ecc) {
                System.out.print(ecc.getMessage());
