...
class learnerform extends JFrame implements Printable, ActionListener, KeyListener {
    String fname = "", hname = "", relation = "";
    ...
    learnerform() {
        ...
        l4 = new JLabel("Learner Licence Number :");
        ...
        try {
            ...
            String sql = "Select learnerlicenseno,name,husbandname,permanentadd,district,city,dob,bg,vehicletype1,vehicletype2,applydate,photoaddress,signatureaddress,relation,fathername,uptovalid from learnerlicense ORDER BY applicantid";
    ...
    learnerform(String get1) {
        ...
        try {
            ...
            Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "manish");
            Statement s = c.createStatement();
            String sql = "Select learnerlicenseno,name,husbandname,permanentadd,district,city,dob,bg,vehicletype1,vehicletype2,applydate,photoaddress,signatureaddress,relation,fathername,uptovalid from learnerlicense where applicantid='"
                    + get1 + "'";
            ResultSet rs = s.executeQuery(sql);
            if (rs.next()) {
                ll1.setText(rs.getString(1));
