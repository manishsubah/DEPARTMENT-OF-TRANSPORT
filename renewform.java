...
class renewform extends JFrame implements Printable, ActionListener, KeyListener {
    ...
    renewform() {
        ...
        try {
            ...
            String sql = "Select applicantid,name,husbandname,permanentadd,district,city,dob,bg,vehicletype1,vehicletype2,applydate,photoaddress,signatureaddress,relation,fathername from drivinglicense ORDER BY applicantid";
    ...
    renewform(String x) {
        ...
        try {
            ...
            Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "manish");
            Statement s = c.createStatement();
            String sql = "Select applicantid,name,husbandname,permanentadd,district,city,dob,bg,vehicletype1,vehicletype2,applydate,photoaddress,signatureaddress,relation,fathername from drivinglicense where applicantid='"
