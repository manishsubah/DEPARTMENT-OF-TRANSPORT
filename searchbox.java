...
class searchbox extends JFrame implements ActionListener, KeyListener {
    ...
    searchbox() {
        ...
        l = new JLabel("SEARCH-LEARNER'S LICENCE");
        ...
        ch1 = new JCheckBox("Learner Licence No.");
        ...
        l1 = new JLabel("Learner Licence No. :");
        ...
        l1.setBounds(270, 80, 250, 30);
        t1.setBounds(500, 80, 300, 30);
        l2.setBounds(270, 120, 150, 30);
        ...
        t4.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                ...
                if (t4.getCaretPosition() == 4) {
                    if (String.valueOf(t4.getText().charAt(3)).equals("1")) {
        ...
        if (e.getSource() == ch1) {
            ...
            if (ch.isSelected() == false) {
                if (ch1.isSelected() == false && ch2.isSelected() == false && ch3.isSelected() == false
                    ...
                    JOptionPane.showMessageDialog(this, "Please Check Desired Item(s).", "Learner Licence-Search",
                    ...
                    JOptionPane.showMessageDialog(this, "Please Enter Learner Licence.", "Learner Licence-Search",
                            JOptionPane.ERROR_MESSAGE);
                    t1.requestFocus();
                } else if ((ch2.isSelected() == true) && (t2.getText()).equals("")) {
                    JOptionPane.showMessageDialog(this, "Please Enter Name.", "Learner Licence-Search",
                            JOptionPane.ERROR_MESSAGE);
                    t2.requestFocus();
                } else if ((ch3.isSelected() == true) && (t3.getText()).equals("")) {
                    JOptionPane.showMessageDialog(this, "Please Enter Father's Name.", "Learner Licence-Search",
                            JOptionPane.ERROR_MESSAGE);
                    t3.requestFocus();
                } else if ((ch4.isSelected() == true) && (t4.getText()).equals("")) {
                    JOptionPane.showMessageDialog(this, "Please Enter D.O.B .", "Learner Licence-Search",
                            JOptionPane.ERROR_MESSAGE);
                    t4.requestFocus();
                } else if ((ch5.isSelected() == true) && (t5.getText()).equals("")) {
                    JOptionPane.showMessageDialog(this, "Please Enter Mobile Number.", "Learner Licence-Search",
                            JOptionPane.ERROR_MESSAGE);
                    t5.requestFocus();
                } else {
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch3.isSelected() == true
                            && ch4.isSelected() == true && ch5.isSelected() == true) {
                        sql = "Select applydate,uptovalid,learnerlicenseno,name,fathername,husbandname,dob,bg,permanentadd,mobile,vehicletype1,vehicletype2,status from learnerlicense WHERE learnerlicenseno='"
                    ...
                    if (ch2.isSelected() == true) {
                        sql = "Select applydate,uptovalid,learnerlicenseno,name,fathername,husbandname,dob,bg,permanentadd,mobile,vehicletype1,vehicletype2,status from learnerlicense where name='"
                                + t2.getText() + "'";
                        
                    }
                    if (ch3.isSelected() == true) {
                        sql = "Select applydate,uptovalid,learnerlicenseno,name,fathername,husbandname,dob,bg,permanentadd,mobile,vehicletype1,vehicletype2,status from learnerlicense where (fathername='"
                                + t3.getText() + "' OR husbandname='" + t3.getText() + "') ";
                    }
                    if (ch4.isSelected() == true) {
                        sql = "Select applydate,uptovalid,learnerlicenseno,name,fathername,husbandname,dob,bg,permanentadd,mobile,vehicletype1,vehicletype2,status from learnerlicense where dob='"
                                + t4.getText() + "'";
                        
                    }
                    if (ch5.isSelected() == true) {
                        sql = "Select applydate,uptovalid,learnerlicenseno,name,fathername,husbandname,dob,bg,permanentadd,mobile,vehicletype1,vehicletype2,status from learnerlicense where mobile='"
                                + t5.getText() + "'";
                    ...
                    try {
                        ...
                        if (rs.next()) {
                            ...
                            JOptionPane.showMessageDialog(this, "Didn't Found.", "Learner Licence-Search",
                                    JOptionPane.ERROR_MESSAGE);
                            if (ch1.isSelected() == true) {
                                t1.requestFocus();
                ...
                // JOptionPane.showMessageDialog(this,"this facility not
                ...
                if (ch1.isSelected() == false && ch2.isSelected() == false && ch3.isSelected() == false
                    ...
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch3.isSelected() == true
                            && ch4.isSelected() == true && ch5.isSelected() == true) {
                        sql1 = "Select * from learnerlicense WHERE learnerlicenseno='" + t1.getText() + "' AND name='"
                                + t2.getText() + "' AND (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') AND dob='" + t4.getText() + "' AND mobile='" + t5.getText() + "'";
                        
                    }
                    if (ch1.isSelected() == true) {
                        sql1 = "Select * from learnerlicense WHERE learnerlicenseno='" + t1.getText() + "'";
                        
                    }
                    if (ch2.isSelected() == true) {
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "'";
                        
                    }
                    if (ch3.isSelected() == true) {
                        sql1 = "Select * from learnerlicense where (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') ";
                    }
                    if (ch4.isSelected() == true) {
                        sql1 = "Select * from learnerlicense where dob='" + t4.getText() + "'";
                        
                    }
                    if (ch5.isSelected() == true) {
                        sql1 = "Select * from learnerlicense where mobile='" + t5.getText() + "'";
                    ...
                    if (ch1.isSelected() == true && ch4.isSelected() == true) {
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND dob='"
                                + t4.getText() + "'";
                        
                    }
                    if (ch1.isSelected() == true && ch5.isSelected() == true) {
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND mobile='"
                                + t5.getText() + "'";
                        
                    }
                    if (ch2.isSelected() == true && ch3.isSelected() == true) {
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "' AND (fathername='"
                                + t3.getText() + "' OR husbandname='" + t3.getText() + "') ";
                        // sql1="Select name,fathername,husbandname from learnerlicense where
                        // name='"+t2.getText()+"' AND (fathername='"+t3.getText()+"' OR
                        // husbandname='"+t3.getText()+"') ";
                    }
                    if (ch2.isSelected() == true && ch4.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull name,dob,.","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "' AND dob='" + t4.getText()
                                + "'";
                        // sql1="Select name,dob from learnerlicense where name='"+t2.getText()+"' AND
                        // dob='"+t4.getText()+"'";
                    }
                    if (ch2.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull name,mobile.","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "' AND mobile='"
                                + t5.getText() + "'";
                        // sql1="Select name,mobile from learnerlicense where name='"+t2.getText()+"'
                        // AND mobile='"+t5.getText()+"'";
                    }
                    if (ch3.isSelected() == true && ch4.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull
                        // fathername,husbandname,dob.","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') AND dob='" + t4.getText() + "'";
                        // sql1="Select fathername,husbandname,dob from learnerlicense where
                        // (fathername='"+t3.getText()+"' OR husbandname='"+t3.getText()+"') AND
                        // dob='"+t4.getText()+"'";
                    }
                    if (ch3.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull
                        // fathername,husbandname,mobile.","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') AND mobile='" + t5.getText() + "'";
                        // sql1="Select fathername,husbandname,mobile from learnerlicense where
                        // (fathername='"+t3.getText()+"' OR husbandname='"+t3.getText()+"') AND
                        // mobile='"+t5.getText()+"'";
                    }
                    if (ch4.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull dob,mobile.","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where dob='" + t4.getText() + "' AND mobile='"
                                + t5.getText() + "' ";
                        // sql1="Select dob,mobile from learnerlicense where dob='"+t4.getText()+"' AND
                        // mobile='"+t5.getText()+"' ";
                    }
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch3.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull
                        // ll,name,fathername,husbandname.","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND name='"
                                + t2.getText() + "' AND (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') ";
                        // sql1="Select learnerlicenseno,name,fathername,husbandname from learnerlicense
                        // where learnerlicenseno='"+t1.getText()+"' AND name='"+t2.getText()+"' AND
                        // (fathername='"+t3.getText()+"' OR husbandname='"+t3.getText()+"') ";
                    }
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch4.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull ll,name,dob.","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND name='"
                                + t2.getText() + "' AND dob='" + t4.getText() + "'";
                        // sql1="Select learnerlicenseno,name,dob from learnerlicense where
                        // learnerlicenseno='"+t1.getText()+"' AND name='"+t2.getText()+"' AND
                        // dob='"+t4.getText()+"'";
                    }
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull. ll,name,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND name='"
                                + t2.getText() + "' AND mobile='" + t5.getText() + "'";
                        // sql1="Select learnerlicenseno,name,mobile from learnerlicense where
                        // learnerlicenseno='"+t1.getText()+"' AND name='"+t2.getText()+"' AND
                        // mobile='"+t5.getText()+"'";
                    }
                    if (ch1.isSelected() == true && ch3.isSelected() == true && ch4.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // ll,fathername,husbandname,dob","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText()
                                + "' AND (fathername='" + t3.getText() + "' OR husbandname='" + t3.getText()
                                + "') AND dob='" + t4.getText() + "'";
                        // sql1="Select learnerlicenseno,husbandname,fathername,dob from learnerlicense
                        // where learnerlicenseno='"+t1.getText()+"' AND (fathername='"+t3.getText()+"'
                        // OR husbandname='"+t3.getText()+"') AND dob='"+t4.getText()+"'";
                    }
                    if (ch1.isSelected() == true && ch3.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // ll,fathername,husbandname,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText()
                                + "' AND (fathername='" + t3.getText() + "' OR husbandname='" + t3.getText()
                                + "') AND mobile='" + t5.getText() + "'";
                        // sql1="Select learnerlicenseno,fathername,husbandname,mobile from
                        // learnerlicense where learnerlicenseno='"+t1.getText()+"' AND
                        // (fathername='"+t3.getText()+"' OR husbandname='"+t3.getText()+"') AND
                        // mobile='"+t5.getText()+"'";
                    }
                    if (ch1.isSelected() == true && ch4.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull. ll,dob,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND dob='"
                                + t4.getText() + "' AND mobile='" + t5.getText() + "'";
                        // sql1="Select learnerlicenseno,dob,mobile from learnerlicense where
                        // learnerlicenseno='"+t1.getText()+"' AND dob='"+t4.getText()+"' AND
                        // mobile='"+t5.getText()+"'";
                    }
                    if (ch2.isSelected() == true && ch4.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull. name,dob,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "' AND dob='" + t4.getText()
                                + "' AND mobile='" + t5.getText() + "'";
                        // sql1="Select name,dob,mobile from learnerlicense where
                        // name='"+t2.getText()+"' AND dob='"+t4.getText()+"' AND
                        // mobile='"+t5.getText()+"'";
                    }
                    if (ch2.isSelected() == true && ch3.isSelected() == true && ch4.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // name,fathername,husbandname,dob","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "' AND (fathername='"
                                + t3.getText() + "' OR husbandname='" + t3.getText() + "') AND dob='" + t4.getText()
                                + "'";
                        // sql1="Select name,fathername,husbandname,dob from learnerlicense where
                        // name='"+t2.getText()+"' AND (fathername='"+t3.getText()+"' OR
                        // husbandname='"+t3.getText()+"') AND dob='"+t4.getText()+"'";
                    }
                    if (ch2.isSelected() == true && ch3.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // name,fathername,husbandname,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "' AND (fathername='"
                                + t3.getText() + "' OR husbandname='" + t3.getText() + "') AND mobile='" + t5.getText()
                                + "'";
                        // sql1="Select name,fathername,husbandname,mobile from learnerlicense where
                        // name='"+t2.getText()+"' AND (fathername='"+t3.getText()+"' OR
                        // husbandname='"+t3.getText()+"') AND mobile='"+t5.getText()+"'";
                    }
                    if (ch3.isSelected() == true && ch4.isSelected() == true && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // fathername,husbandname,dob,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') AND dob='" + t4.getText() + "' AND mobile='" + t5.getText() + "'";
                        // sql1="Select fathername,husbandname,dob,mobile from learnerlicense where
                        // (fathername='"+t3.getText()+"' OR husbandname='"+t3.getText()+"') AND
                    ...
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch3.isSelected() == true
                            && ch4.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // ll,name,fathername,husbandname,dob","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND name='"
                                + t2.getText() + "' AND (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') AND dob='" + t4.getText() + "'";
                        // sql1="Select learnerlicenseno,name,fathername,husbandname,dob from
                        // learnerlicense where learnerlicenseno='"+t1.getText()+"' AND
                        // name='"+t2.getText()+"' AND (fathername='"+t3.getText()+"' OR
                        // husbandname='"+t3.getText()+"') AND dob='"+t4.getText()+"'";
                    }
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch3.isSelected() == true
                            && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // ll,name,fathername,husbandname,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND name='"
                                + t2.getText() + "' AND (fathername='" + t3.getText() + "' OR husbandname='"
                                + t3.getText() + "') AND mobile='" + t5.getText() + "'";
                        // sql1="Select learnerlicenseno,name,fathername,husbandname,mobile from
                        // learnerlicense where learnerlicenseno='"+t1.getText()+"' AND
                        // name='"+t2.getText()+"' AND (fathername='"+t3.getText()+"' OR
                        // husbandname='"+t3.getText()+"') AND mobile='"+t5.getText()+"'";
                    }
                    if (ch1.isSelected() == true && ch3.isSelected() == true && ch4.isSelected() == true
                            && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // ll,fathername,husbandname,dob,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText()
                                + "' AND (fathername='" + t3.getText() + "' OR husbandname='" + t3.getText()
                                + "') AND dob='" + t4.getText() + "' AND mobile='" + t5.getText() + "'";
                        // sql1="Select learnerlicenseno,fathername,husbandname,dob,mobile from
                        // learnerlicense where learnerlicenseno='"+t1.getText()+"' AND
                        // (fathername='"+t3.getText()+"' OR husbandname='"+t3.getText()+"') AND
                        // dob='"+t4.getText()+"' AND mobile='"+t5.getText()+"'";
                    }
                    if (ch1.isSelected() == true && ch2.isSelected() == true && ch4.isSelected() == true
                            && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull. ll,name,dob,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where learnerlicenseno='" + t1.getText() + "' AND name='"
                                + t2.getText() + "' AND dob='" + t4.getText() + "' AND mobile='" + t5.getText() + "'";
                        // sql1="Select learnerlicenseno,name,dob,mobile from learnerlicense where
                        // learnerlicenseno='"+t1.getText()+"' AND name='"+t2.getText()+"' AND
                        // dob='"+t4.getText()+"' AND mobile='"+t5.getText()+"'";
                    }
                    if (ch2.isSelected() == true && ch3.isSelected() == true && ch4.isSelected() == true
                            && ch5.isSelected() == true) {
                        // JOptionPane.showMessageDialog(this,"Successfull.
                        // name,fathername,husbandname,dob,mobile","Learner
                        // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        sql1 = "Select * from learnerlicense where name='" + t2.getText() + "' AND (fathername='"
                                + t3.getText() + "' OR husbandname='" + t3.getText() + "') AND dob='" + t4.getText()
                                + "' AND mobile='" + t5.getText() + "'";
                        // sql1="Select name,fathername,husbandname,dob,mobile from learnerlicense where
                        // name='"+t2.getText()+"' AND (fathername='"+t3.getText()+"' OR
                        // husbandname='"+t3.getText()+"') AND dob='"+t4.getText()+"' AND
                        // mobile='"+t5.getText()+"'";
                    }
                    ...
                    try {
                        ...
                        Statement s = c.createStatement();
                        // String sql1="Select
                        // formno,learnerlicenseno,applydate,applicantid,name,sex,relation,fathername,dob,bg,permanentadd,villtown,district,city,pin1,mobile,uptovalid,status
                        // from learnerlicense";
                        ...
                        if (rs.next()) {
                            ...
                            new dialog1();
                            // JOptionPane.showMessageDialog(this,sql,"Learner
                            // Licence-Search",JOptionPane.ERROR_MESSAGE);
                        } else {
                            JOptionPane.showMessageDialog(this, "Didn't Found.", "Learner Licence-Search",
                                    JOptionPane.ERROR_MESSAGE);
            ...
            if (e.getSource() == b3) {
                ...
                if (t1.isEditable() != false) {
                    if ((t1.getText()).equals("") || (t1.getText()).equals(null)) {
                        JOptionPane.showMessageDialog(this, "Please Enter Learner Licence.", "Search-Learner Licence",
                                JOptionPane.ERROR_MESSAGE);
                        t1.requestFocus();
                    } else {
                        if (ch2.isSelected() == true) {
                ...
                if (t2.isEditable() != false) {
                    if ((t2.getText()).equals("") || (t2.getText()).equals(null)) {
                        JOptionPane.showMessageDialog(this, "Please Enter Name.", "Search-Learner Licence",
                                JOptionPane.ERROR_MESSAGE);
                        t2.requestFocus();
                    } else {
                        if (ch3.isSelected() == true) {
                ...
                if (t3.isEditable() != false) {
                    if ((t3.getText()).equals("") || (t3.getText()).equals(null)) {
                        JOptionPane.showMessageDialog(this, "Please Enter Father's Name.", "Search-Learner Licence",
                                JOptionPane.ERROR_MESSAGE);
                        t3.requestFocus();
                    } else {
                        if (ch4.isSelected() == true) {
                ...
                try {
                    if (t4.isEditable() != false) {
                        if ((t4.getText()).equals("") || (t4.getText()).equals(null)) {
                            ...
                            String t = t4.getText();
                            if (String.valueOf(t.charAt(2)).equals("/") && String.valueOf(t.charAt(5)).equals("/")) {
                                if (ch5.isSelected() == true) {
                                    t5.requestFocus();
                                } else {
                                    b1.requestFocus();
                                ...
                                JOptionPane.showMessageDialog(this, "Invalid Date of Birth Format(dd/mm/yyyy).",
                ...
                if (t5.isEditable() != false) {
                    if ((t5.getText()).equals("") || (t5.getText()).equals(null)) {
                        JOptionPane.showMessageDialog(this, "Please Enter Mobile Number.", "Search-Learner Licence",
                                JOptionPane.ERROR_MESSAGE);
                        t5.requestFocus();
                    } else {
                        b1.requestFocus();
    ...
    private class dialog {
        ...
        dialog() {
            ...
            try {
                ...
                ResultSet rs = s.executeQuery(sql);
                if (rs.next()) {
                    String columns[] = { "Apply Date", "Up to Valid", "Learner License No.", "Name", "Frather's Name",
                            "Husband's Name", "DOB", "BG", "Permanent Add", "Mobile Number", "Type of Vehicle1",
        ...
        dialog1() {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    Object rows[][] = {
                            { rs.getString("applydate"), rs.getString("uptovalid"), rs.getString("learnerlicenseno"),
