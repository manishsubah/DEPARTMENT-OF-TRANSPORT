...
class searchll extends JFrame implements KeyListener, ActionListener {
    ResultSet rs;
    ...
    JLabel ll, l, lp, l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21,
            l22, l23, lvclass;
    JTextField ta, ta1, ta2, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, tvclass, tcb1, tcb2,
            trd;
    ...
    searchll() {
        setTitle("Search-Learner Licence");
        setSize(1350, 730);
        setResizable(false);
        ...
        l = new JLabel("Search-Learner Licence");
        l.setForeground(Color.white);
        l.setFont(new Font("Bookman Old Style", Font.BOLD, 20));

        l1 = new JLabel("Date of Applied to Valid Upto :");
        ...
        s = new JLabel("Status :");
        s.setFont(new Font("Bookman Old Style", Font.PLAIN, 17));
        ...
        tvclass = new JTextField();
        tvclass.setFont(new Font("Bookman Old Style", Font.PLAIN, 14));
        ...
        l.setBounds(570, 18, 350, 30);

        panel2.setBounds(0, 60, 1350, 560);
        l1.setBounds(18, 30, 250, 30);
        ...
        tvclass.setBounds(1150, 470, 150, 30);
        ...
        try {
            ...
            if (rs.next()) {
                ...
                tvclass.setText(rs.getString(28));
                pa = rs.getString(29);
                sa = rs.getString(30);
                tha = rs.getString(31);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b3) {
            ...
            if (ch1.isSelected() == false) {
                ...
                up = "Select photoproof from applicationdl WHERE applicantid='" + t2.getText() + "'";
                new photo();
            }
            ...
            if (ch2.isSelected() == false) {
                ...
                up = "Select addressproof from applicationdl WHERE applicantid='" + t2.getText() + "'";
                new photo();
            }
            ...
            if (ch3.isSelected() == false) {
                ...
                up = "Select bgproof from applicationdl WHERE applicantid='" + t2.getText() + "'";
                new photo();
            }
