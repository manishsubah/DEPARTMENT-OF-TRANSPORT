...
class llreport extends JFrame implements ActionListener, KeyListener {
    String sql = "";
    JLabel l1, l2, l3;
    JTextField t1;
    JButton b1, b2;
    ...
    llreport() {
        ...
        l1 = new JLabel("LEARNER LICENCE-REPORT");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b1) {
            if (ch1.isSelected() == false && ch2.isSelected() == false && ch3.isSelected() == false) {
                JOptionPane.showMessageDialog(this, "Please Check Desired Item(s).", "Learner Licence-Report",
                ...
                if (ch2.isSelected() == true) {
                    try {
                        ...
                        sql = "Select applydate,uptovalid,learnerlicenseno,name,dob,vehicletype1,vehicletype2,status from learnerlicense ORDER BY applicantid";
                        c.close();
                    } catch (Exception eee) {
                    }
                    new dialog();
                    ...
                    if (t1.getText().length() != 10) {
                        ...
                        try {
                            ...
                            Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system",
                                    "manish");
                            Statement s = c.createStatement();
                            sql = "Select applydate,uptovalid,learnerlicenseno,name,dob,vehicletype1,vehicletype2,status from learnerlicense where applydate='"
            ...
            if (e.getSource() == t1) {
                if (t1.isEditable() == true) {
                    if ((t1.getText()).equals("") || (t1.getText()).equals(null)) {
                        JOptionPane.showMessageDialog(this, "Please Enter Date.", "Learner Licence-Report",
                                JOptionPane.ERROR_MESSAGE);
                        t1.requestFocus();
                    } else {
                        b1.requestFocus();
    ...
    private class dialog extends JFrame {
        ...
        dialog() {
            setTitle("Result-Learner Licence Report");
            setSize(1000, 300);
