...
class approvalrenew extends JFrame implements KeyListener, ActionListener {
    ResultSet rs;
    ...
    approvalrenew() {
        ...
        l = new JLabel("RENEWAL APPROVAL-DRIVING LICENCE");
        ...
        ll = new JLabel("Learner License Number :");
        ...
        lvclass = new JLabel("Type of Vehicle :");
        ...
        try {
            ...
            sql = "Select * from drivinglicense WHERE status='PENDING' ORDER BY applicantid";
        ...
        if (e.getSource() == b1) {
            if ((trd.getText()).equals("S/O") || (trd.getText()).equals("D/O")) {
                try {
                    ...
                    s.executeUpdate("UPDATE drivinglicense SET status='APPROVED' WHERE learnerlicenseno='"
                            + t13.getText() + "' AND applicantid='" + t2.getText() + "' ");
                    c.close();
                } catch (Exception ec) {
                    JOptionPane.showMessageDialog(this, ec.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            ...
            JOptionPane.showMessageDialog(this, "Renewed Driving Licenece or Approved.", "Renewal-DL",
            ...
            if ((trd.getText()).equals("S/O") || (trd.getText()).equals("D/O")) {
                try {
                    ...
                    Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system",
                            "manish");
                    Statement s = c.createStatement();
                    String sql = "INSERT INTO appdlstatus VALUES('" + t2.getText() + "','" + t1.getText() + "','"
                            + t3.getText() + "','','" + t4.getText() + "','" + t14.getText() + "','" + tcb2.getText()
                            + "','" + t9.getText() + "','DISAPPROVED') ";
                    String sql1 = "UPDATE drivinglicense SET status='DISAPPROVED' WHERE learnerlicenseno='"
                            + t13.getText() + "' AND applicantid='" + t2.getText() + "'";
                ...
                try {
                    ...
                    s.executeQuery("INSERT INTO appdlstatus VALUES('" + t2.getText() + "','" + t1.getText() + "','"
                            + t3.getText() + "','" + t4.getText() + "','','" + t14.getText() + "','" + tcb2.getText()
                            + "','" + t9.getText()
                            + "','DISAPPROVED');UPDATE drivinglicense SET status='DISAPPROVED' WHERE learnerlicenseno='"
                            + t13.getText() + "' AND applicantid='" + t2.getText() + "'; ");
                    c.close();
                } catch (Exception ep) {
                }
            }
            JOptionPane.showMessageDialog(this, "Application Disapproved.", "Renewal-DL",
                    JOptionPane.INFORMATION_MESSAGE);
        }
        if (e.getSource() == b3) {
            dispose();
            ...
            if (ch1.isSelected() == false) {
                ...
                up = "Select photoproof from drivinglicense WHERE applicantid='" + t2.getText() + "'";
                new photo();
            }
            ...
            if (ch2.isSelected() == false) {
                ...
                up = "Select addressproof from drivinglicense WHERE applicantid='" + t2.getText() + "'";
                new photo();
            }
            ...
            if (ch3.isSelected() == false) {
                ...
                up = "Select bgproof from drivinglicense WHERE applicantid='" + t2.getText() + "'";
                new photo();
            }
        }
