...
class vclass extends JFrame implements ActionListener, KeyListener {
    ...
    vclass() {
        ...
        try {
            ...
            Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "manish");
            Statement s = c.createStatement();
            String sql = "Select vehicletype1,vehicletype2 From feeparticulardescription WHERE applicantid='"
                    + applicantid + "'";
        ...
        if (e.getSource() == b1) {
            if (ch2.isSelected() == false && ch3.isSelected() == false && ch4.isSelected() == false
                ...
                JOptionPane.showMessageDialog(this,
                        "Please Check Desired Item(s).If you know the vehicle type(s) that is applied. ",
                        "Vehicle Class", JOptionPane.ERROR_MESSAGE);
                ch2.requestFocus();
            } else {
                ...
                try {
                    ...
                    Connection c = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system",
                            "manish");
                    Statement s = c.createStatement();
                    String sql = ("UPDATE applicationlearner SET vehicletype1='" + v1 + "' where applicantid='"
                            + applicantid + "'");
                    String sql1 = ("UPDATE applicationlearner SET vehicletype2='" + v2 + "' where applicantid='"
                            + applicantid + "'");
