...
class approvall extends JFrame implements KeyListener, ActionListener {
    ResultSet rs;
    String learnerlicenseno = "LL3000";
    JScrollPane sp;
    JLabel lup;
    String fname = "", hname = "", pp = "", ap = "", bp = "", pa = "", sa = "", tha = "";
    String sql = "", up = "";
    JLabel lv, l, lp, l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21,
            l22, l23;
    JTextField ta, ta1, ta2, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, tcb1, tcb2, trd,
            t17;
    JComboBox cb1, cb2;
    ...
    JButton b1, b2, b3, b4, b5, up1, up2, up3, next, previous;
    Date date = new Date();
    Calendar now = Calendar.getInstance();
    String valid = "";

    approvall() {
        setTitle("Approaval-Learner's Licence");
        setSize(1350, 730);
        setResizable(false);
        ...
        l = new JLabel("APPROVAL-LEARNER'S LICENCE");
        ...
        lv = new JLabel("Type of Vehicle :");
        lv.setFont(new Font("Bookman Old Style", Font.PLAIN, 16));
        ...
        t17 = new JTextField();
        t17.setFont(new Font("Bookman Old Style", Font.PLAIN, 14));
        ...
        t13.setBounds(830, 515, 140, 30);
        t17.setBounds(990, 515, 140, 30);

        b5.setBounds(1140, 515, 180, 30);
        ...
        try {
            ...
            sql = "Select * from applicationlearner WHERE status='PENDING' ORDER BY applicantid";
            ...
            if (rs.next()) {
                ...
                ta1.setText(rs.getString(21));
                ta2.setText(rs.getString(22));
                t12.setText(rs.getString(23));
                t11.setText(rs.getString(24));
                t10.setText(rs.getString(25));
                t9.setText(rs.getString(26));
                t13.setText(rs.getString(27));
                t17.setText(rs.getString(28));
                pa = rs.getString(29);
                sa = rs.getString(30);
                tha = rs.getString(31);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b1) {
            try {
                ...
                ResultSet rs = s.executeQuery("select count(learnerlicenseno) from learnerlicense");
                if (rs.next()) {

                    learnerlicenseno = learnerlicenseno + String.valueOf(Integer.valueOf(rs.getString(1)) + 1);
            ...
            if ((trd.getText()).equals("S/O") || (trd.getText()).equals("D/O")) {
                try {
                    ...
                    Statement s = c.createStatement();
                    s.executeQuery("INSERT INTO learnerlicense VALUES('" + l2.getText() + "','" + t1.getText() + "','"
                            ...
                            + t8.getText() + "','" + t15.getText() + "','" + t16.getText() + "','" + pp + "','" + ap
                            + "','" + bp + "','" + ta1.getText() + "','" + ta2.getText() + "','" + t12.getText() + "','"
                            + t11.getText() + "','" + t10.getText() + "','" + t9.getText() + "','" + t13.getText()
                            + "','" + t17.getText() + "','" + pa + "','" + sa + "','" + tha + "','" + valid + "','"
                            + learnerlicenseno + "','APPROVED')");
                    c.close();
                } catch (Exception ec) {
                    JOptionPane.showMessageDialog(this, ec.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
                try {
                    ...
                    s1.executeUpdate(
                            "UPDATE applicationlearner SET status='APPROVED' WHERE applicantid='" + t2.getText() + "'");
                    Statement s = c.createStatement();
                    s.executeQuery("INSERT INTO applearnerstatus VALUES('" + t2.getText() + "','" + t1.getText() + "','"
            ...
            learnerlicenseno = "LL3000";
            JOptionPane.showMessageDialog(this, "Application Approved.", "Approval-LL",
            ...
            if ((trd.getText()).equals("S/O") || (trd.getText()).equals("D/O")) {
                try {
                    ...
                    Statement s1 = c.createStatement();
                    s1.executeUpdate("UPDATE applicationlearner SET status='DISAPPROVED' WHERE applicantid='"
                            + t2.getText() + "'");
                    Statement s = c.createStatement();
                    s.executeQuery("INSERT INTO applearnerstatus VALUES('" + t2.getText() + "','" + t1.getText() + "','"
                            + t3.getText() + "','','" + t4.getText() + "','" + t14.getText() + "','" + tcb2.getText()
            ...
            JOptionPane.showMessageDialog(this, "Application Disapproved.", "Approval-LL",
                    JOptionPane.INFORMATION_MESSAGE);
            ...
            try {
                if (!(rs.isFirst() == true)) {
                    ...
                    JOptionPane.showMessageDialog(this, "No more records found.", "Error", JOptionPane.ERROR_MESSAGE);
                }
